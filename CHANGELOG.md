...
- Wrapped `JwtTokenInterceptor` exceptions in an IOException to prevent crashes
...
[4.3.0]: https://github.com/phunware/maas-analytics-android-sdk/compare/4.2.0...4.3.0
